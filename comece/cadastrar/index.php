...
$dados['afiliado'] = 'valorAfiliado';

$afiliado = $dados['afiliado'];

$afiliado = $_SESSION['afiliado'] = 'valorAfiliado' ;
?>
...
<?php
  ...
  if (isset($_POST['formdata'])) {
    ...
    // Access data within the $formdata array
} else {
    // Handle the case where "formdata" is not present (e.g., display an error message)
                        ...
                        <div class="fake-select">
                          ...
                          <select id="input-segmento" name="segmento">
                              ...
                              ?>
                                ...
                                <option  <?php if( 'segmento' == $quickdata['id'] ) { echo "SELECTED"; }; ?> value=<?php echo $quickdata['id']; ?>><?php echo $quickdata['nome']; ?></option>
                ...
                <div class="row">
                  ...
                  <div class="col-md-12">
                    ...
                    <div class="form-field-default">
                        ...
                        <input type="radio" name="pagamento_dinheiro" value="1" <?php if(isset($_POST['pagamento_dinheiro']) && $_POST['pagamento_dinheiro'] == 1) { echo 'CHECKED'; } else if (!isset($_POST['pagamento_dinheiro'])) { echo 'CHECKED'; } ?>> Sim
                        </div>
                        <div class="form-field-radio">
                ...
                <div class="row">
                  ...
                  <div class="col-md-12">
                    ...
                    <div class="form-field-default">
                        ...
                        <div class="form-field-radio">
                        <input type="radio" name="pagamento_cartao_debito" value="1" element-show=".elemento-bandeiras-debito" <?php if( isset($_POST['pagamento_cartao_debito'] )== 1 && !$_POST['pagamento_cartao_debito'] ){ echo 'CHECKED'; }; ?>> Sim
                        </div>
                        <div class="form-field-radio">
                        <input type="radio" name="pagamento_cartao_debito" value="2" element-hide=".elemento-bandeiras-debito" <?php if(isset( $_POST['pagamento_cartao_debito'] ) == 2 && $_POST['pagamento_cartao_debito']) { echo 'CHECKED'; }; ?>> Não
                        </div>
                        <div class="clear"></div>
                ...
                <div class="row">
                  ...
                  <div class="col-md-12">
                    ...
                    <div class="form-field-default">
                        ...
                        <div class="form-field-radio">
                        <input type="radio" name="pagamento_cartao_credito" value="1" element-show=".elemento-bandeiras-credito" <?php if( isset( $_POST['pagamento_cartao_credito'] ) && !$_POST['pagamento_cartao_credito']  == 1 ){ echo 'CHECKED'; }; ?>> Sim
                        </div>
                        <div class="form-field-radio">
                ...
                <div class="row">
                  ...
                  <div class="col-md-12">
                    ...
                    <div class="form-field-default">
                        ...
                        <div class="form-field-radio">
                          <input type="radio" name="pagamento_cartao_alimentacao" value="2" element-hide=".elemento-bandeiras-alimentacao" <?php if( isset( $_POST['pagamento_cartao_alimentacao'])  && $_POST['pagamento_cartao_alimentacao'] == 2 ){ echo 'CHECKED'; }; ?>> Não
                        </div>
                        <div class="clear"></div>
                ...
                <div class="row">
                  ...
                  <div class="col-md-12">
                    ...
                    <div class="form-field-default">
                        ...
                        <div class="form-field-radio">
                          <input type="radio" name="pagamento_outros" value="1" element-show=".elemento-outraforma" <?php if(isset( $_POST['pagamento_cartao_alimentacao'] ) && $_POST['pagamento_outros'] == 1 ){ echo 'CHECKED'; }; ?>> Sim
                        </div>
                        <div class="form-field-radio">
                          <input type="radio" name="pagamento_outros" value="2" element-hide=".elemento-outraforma" <?php if(isset( $_POST['pagamento_cartao_alimentacao'] ) && $_POST['pagamento_outros'] == 2){ echo 'CHECKED'; }; ?>> Não
                        </div>
                        <div class="clear"></div>
                ...
                <div class="row">
                  ...
                  <div class="col-md-12">
                    ...
                    <div class="form-field-default">
                        ...
                        <div class="form-field-radio">
                          <input type="radio" name="entrega_retirada" value="1" <?php if(isset( $_POST['entrega_retirada']) &&!$_POST['entrega_retirada'] ==1 ){ echo 'CHECKED'; }; ?>> Sim
                        </div>
                        <div class="form-field-radio">
                ...
                <div class="row">
                  ...
                  <div class="col-md-12">
                    ...
                    <div class="form-field-default">
                        ...
                        <div class="form-field-radio">
                          <input type="radio" name="entrega_entrega" value="1" element-show=".elemento-frete" <?php  if( isset( $_POST['entrega_entrega']) && !$_POST['entrega_entrega'] == 1 ){ echo 'CHECKED'; }; ?>> Sim
                        </div>
                        <div class="form-field-radio">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-12">
                      ...
                      <div class="form-field-default">
                          ...
                          <div class="form-field-radio">
                            <input type="radio" name="entrega_entrega_tipo" value="1" element-show=".elemento-frete-valor" <?php if( isset( $_POST['entrega_entrega_tipo']) && !$_POST['entrega_entrega_tipo'] == 1 ){ echo 'CHECKED'; }; ?>> Valor fixo
                          </div>
                          <div class="form-field-radio">
