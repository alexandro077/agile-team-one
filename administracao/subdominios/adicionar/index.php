...
<?php
  ...
  if( $formdata ) {
    ...
    $subdominio = subdomain( mysqli_real_escape_string( $db_con, isset($_POST['subdominio']) ) );
    $tipo = mysqli_real_escape_string( $db_con, isset($_POST['tipo']) );
    $estabelecimento = mysqli_real_escape_string( $db_con, isset($_POST['estabelecimento_id']) );
    $cidade = mysqli_real_escape_string( $db_con, isset($_POST['cidade_id']) );
    $rel_id = "";
    if( $tipo == "1" ) {
